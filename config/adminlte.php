...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => "Bank",
            'translation' => "menu.item.banks",
            'route'  => 'backend.banks.index',
            'topnav' => true,
        ],
        [
            'text' => 'Currency',
            'translation' => "menu.item.currency",
            'route'  => 'backend.currency.index',
            'topnav' => true,
        ],
        [
            'text' => 'Exchange rate',
            'translation' => "menu.item.exchange_rate",
            'route'  => 'backend.exchange-rate.index',
            'topnav' => true,
        ],
        [
            'text' => "Localization",
            'translation' => "menu.item.localization",
            'route'  => 'backend.translator.translations.index',
            'topnav' => true,
        ],
    ],
    ...
    */
    ...
    'filters' => [
        ...
        App\AdminLte\MenuFilter\TranslateMenuFilter::class
    ],
